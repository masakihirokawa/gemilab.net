...
const CONTENT = {
  ja: {
    heading: "さらに深く学びたい方へ",
    description:
      "Gemini Lab では、この記事の内容をさらに掘り下げた上級ガイドをプレミアム記事として公開しています。実装コード・ベンチマーク・本番設計パターンなど、すぐに使える実践的な内容です。",
    features: [
      "コピー&ペーストで使える実装コード付き",
      "毎週新しい上級ガイドを追加",
  ...
  en: {
    heading: "Go Deeper",
    description:
      "Gemini Lab publishes premium articles that go deeper into the topics covered here — with implementation code, benchmarks, and production-ready design patterns.",
    features: [
