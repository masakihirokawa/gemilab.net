...
const CONTENT = {
  ja: {
    heading: "さらに深く学びたい方へ",
    description:
      "この記事を気に入っていただけましたか？Gemini Lab メンバーシップでは、プレミアム限定の上級ガイドやチュートリアルにアクセスできます。",
    features: [
      "すべてのプレミアム記事が読み放題",
      "毎週追加される限定コンテンツ",
      "上級テクニック・実践ガイド",
  ...
  en: {
    ...
    description:
      "Enjoyed this article? Gemini Lab membership gives you access to exclusive premium guides and advanced tutorials.",
    features: [
