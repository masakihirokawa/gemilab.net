  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {locale === "ja"
            ? "この記事の続きは Gemini Lab メンバー限定です。すべてのプレミアム記事にアクセスできます。"
            : "The rest of this article is for Gemini Lab members. Get access to all premium articles."}
        </p>
