...
const META = {
  ja: {
    title: "プライバシーポリシー — Gemini Lab",
    description: "Gemini Lab のプライバシーポリシー。個人情報の取り扱い、Cookie・決済情報の管理、第三者サービスの利用について説明します。",
  },
  en: {
    title: "Privacy Policy — Gemini Lab",
    description: "Gemini Lab Privacy Policy. How we handle personal information, cookies, payment data, and third-party services.",
  },
};
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        "x-default": "https://gemilab.net/en/privacy",
      },
    },
  };
}
  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 24px 120px" }}>
      ...
      <p style={{ fontSize: 14, color: "var(--text-dim)", marginBottom: 36, lineHeight: 1.6 }}>
        {isJa
          ? "Gemini Lab（以下「当サイト」）は、ユーザーの皆さまのプライバシーを尊重し、個人情報の適切な保護に努めます。本ポリシーでは、当サイトにおける情報の収集・利用・管理について説明いたします。"
          : "Gemini Lab (\"this site\") is committed to respecting your privacy and protecting personal information. This policy explains how we collect, use, and manage information on this site."}
      </p>
