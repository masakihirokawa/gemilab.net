    ...
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 24px 120px" }}>
      ...
      <div className="article-content">
        {isJa ? (
          <>
            <h2>個人情報の取り扱いについて</h2>
            <p>Gemini Lab（以下「当サイト」）は、ユーザーのプライバシーを尊重し、個人情報の保護に努めます。</p>
            <h2>収集する情報</h2>
          ...
          <>
            ...
            <p>Gemini Lab (&quot;this site&quot;) respects user privacy and is committed to protecting personal information.</p>
