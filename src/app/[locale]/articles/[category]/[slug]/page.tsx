...
import { getArticle, getAllArticleSlugs, CATEGORIES, getArticleContent, getTagCounts } from "@/lib/content";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const url = `https://gemilab.net${prefix}/articles/${category}/${slug}`;
  ...
  return {
    ...
    twitter: {
      ...
      title: article.meta.title,
      description: article.meta.description,
      images: [{ url: "https://gemilab.net/og/default.png", alt: article.meta.title }],
    },
    alternates: {
      canonical: url,
      languages: {
        ja: `https://gemilab.net/articles/${category}/${slug}`,
        en: `https://gemilab.net/en/articles/${category}/${slug}`,
        "x-default": `https://gemilab.net/en/articles/${category}/${slug}`,
      },
    },
  };
}
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Home",
        item: `https://gemilab.net${prefix || "/"}`,
      },
      {
        "@type": "ListItem",
        position: 2,
        name: CATEGORY_LABELS[locale]?.[category] || category,
        item: `https://gemilab.net${prefix}/articles/${category}`,
      },
      {
        "@type": "ListItem",
        position: 3,
  ...
  return (
    ...
    <article style={{ maxWidth: 740, margin: "0 auto", padding: "40px 24px 120px" }}>
      ...
      {!canViewPremium && !article.meta.premium && (
        <MembershipStickyBar locale={locale} siteName="Gemini Lab" />
      )}
