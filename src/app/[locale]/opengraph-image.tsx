...
export const alt = "Gemini Lab — Gemini 日本語ナレッジベース";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Outer ring */}
        <div style={{ position:"absolute", left:755, top:170, width:290, height:290,
          borderRadius:"50%", border:`22px solid ${brand}20`, display:"flex",
          alignItems:"center", justifyContent:"center" }}>
          {/* Outer ring outline */}
          <div style={{ position:"absolute", left:-1, top:-1, width:290, height:290,
            borderRadius:"50%", border:`2px solid ${brand}60`, display:"flex" }} />
          {/* Inner ring */}
          <div style={{ width:162, height:162, borderRadius:"50%", border:`18px solid ${brand}20`,
            display:"flex", alignItems:"center", justifyContent:"center", position:"relative" }}>
            <div style={{ position:"absolute", left:-1, top:-1, width:162, height:162,
              borderRadius:"50%", border:`2px solid ${brand}60`, display:"flex" }} />
          </div>
        </div>
        {/* Content */}
        <div style={{ position:"absolute", left:80, top:138, display:"flex", flexDirection:"column" }}>
          <div style={{ display:"flex", alignItems:"center", backgroundColor:`${brand}22`,
            ...
            <span style={{ fontSize:12, fontWeight:700, letterSpacing:"1.8px", color:brand }}>GEMINI AI KNOWLEDGE BASE</span>
          </div>
          <div style={{ display:"flex", flexDirection:"column", marginBottom:28 }}>
            <span style={{ fontSize:84, fontWeight:800, color:"#ffffff", letterSpacing:"-2px", lineHeight:1 }}>Gemini</span>
            <span style={{ fontSize:84, fontWeight:300, color:"#ffffff", opacity:0.78, letterSpacing:"-2px", lineHeight:1 }}>Lab</span>
          </div>
          <span style={{ fontSize:22, color:brand, opacity:0.88, letterSpacing:"1px", marginBottom:22 }}>gemilab.net</span>
