...
export default async function TagPage({ params, searchParams }: Props) {
   ...
   * Reverses #85 because the 0-article path was generating 100s of real 404s in GSC
   * after the large 2026-05 content cleanup (Claude Lab: 383 hits, Gemini Lab: 163 hits).
   * The page is already marked noindex via generateMetadata's robots field,
   * so Google will naturally de-index it; meanwhile users get useful navigation. */
