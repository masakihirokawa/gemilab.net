...
const META: Record<string, { title: string; description: string }> = {
  ja: {
    title: "Gemini Lab を応援する",
    description: "Gemini Lab の活動を支援していただける方へ。Ko-fi、PayPal、Wise、Revolut でサポートできます。",
  },
  en: {
    title: "Support Us",
    description: "Support Gemini Lab's work. You can contribute via Ko-fi, PayPal, Wise, or Revolut.",
  },
};
...
const STRIPE_TIP: Record<string, { priceId: string }> = {
  ja: { priceId: "price_1TALKCEGB5g6A54oWoPeQXYi" }, // ¥300 JPY
  en: { priceId: "price_1TALKDEGB5g6A54o4WPDSxag" }, // $3 USD
};
...
const CONTENT: Record<string, {
  ...
  en: {
    heading: "Support Gemini Lab",
    sub: "Gemini Lab is free and ad-free. If you've found it helpful, a small contribution means a lot and helps keep the site running ♥",
