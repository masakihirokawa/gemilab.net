...
const META = {
  ja: {
    title: "運営者について — Gemini Lab",
    description: "Gemini Lab 運営者・廣川政樹のプロフィール。現代美術家・デジタルクリエイター・アプリデベロッパー。国際芸術賞17冠。",
  },
  en: {
    title: "About — Gemini Lab",
    description: "About the founder of Gemini Lab — Masaki Hirokawa. Contemporary artist, digital creator, and app developer. Recipient of 17 international art awards.",
  },
};
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: locale === "ja" ? "https://gemilab.net/about" : "https://gemilab.net/en/about",
      languages: {
        ja: "https://gemilab.net/about",
        en: "https://gemilab.net/en/about",
        "x-default": "https://gemilab.net/en/about",
      },
    },
  };
}
