    ...
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 24px 120px" }}>
      ...
      >
        ...
        <MembershipPlans
          locale={locale}
          stripeConfig={{
            pro: { priceId: locale === "ja" ? "price_1TCQykEGB5g6A54oRZa4faF7" : "price_1TCQymEGB5g6A54oyBTnCcRh" },
            premium: { priceId: locale === "ja" ? "price_1TCQyxEGB5g6A54o56MtETkI" : "price_1TCQyzEGB5g6A54odkusafTp" },
          }}
        />
      </section>
