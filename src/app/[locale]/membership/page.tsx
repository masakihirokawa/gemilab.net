...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title: m.title, description: m.description, images: [{ url: "https://gemilab.net/og/default.png", width: 1200, height: 630, alt: "Gemini Lab", type: "image/png" }] },
    alternates: {
      canonical:
        locale === "ja"
          ? "https://gemilab.net/membership"
          : "https://gemilab.net/en/membership",
      languages: {
        ja: "https://gemilab.net/membership",
        en: "https://gemilab.net/en/membership",
        "x-default": "https://gemilab.net/en/membership",
      },
    },
  };
}
...
const PAGE_TEXT = {
  ja: {
    ...
    description:
      "Gemini Lab をご覧いただきありがとうございます。コピー&ペーストで使える実装コード、ベンチマーク結果、本番設計パターンを含む上級ガイドを毎週追加しています。無料記事で基礎を学んだ後の「次の一歩」として、お役に立てれば幸いです。",
    features: [
      "すべてのプレミアム記事が読み放題",
      "毎週追加される実装コード付き上級ガイド",
  ...
  en: {
    ...
    description:
      "Thank you for visiting Gemini Lab. We publish advanced guides weekly with copy-paste ready code, benchmarks, and production design patterns — practical content we hope you'll find useful as the next step after our free articles.",
    features: [
