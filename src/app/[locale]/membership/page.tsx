...
const META = {
  ja: {
    title: "メンバーシップ",
    description:
      "Gemini Lab メンバーシップで、プレミアム限定の上級ガイドやチュートリアルにアクセス。Pro プラン（¥500/月）と Premium プラン（¥2,980 永久アクセス）をご用意しています。",
  },
  en: {
    title: "Membership",
    description:
      "Access exclusive premium guides and advanced tutorials with Gemini Lab Membership. Choose from Pro ($5/mo) or Premium ($19 lifetime).",
  },
};
