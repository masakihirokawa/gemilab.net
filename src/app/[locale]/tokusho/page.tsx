...
const META = {
  ja: {
    title: "特定商取引法に基づく表記 — Gemini Lab",
    description: "Gemini Lab の特定商取引法に基づく表記。販売事業者、販売価格、支払方法、返品・キャンセルポリシーについて。",
  },
  en: {
    title: "Legal Notice (Tokushoho) — Gemini Lab",
    description: "Legal notice for Gemini Lab under the Japanese Act on Specified Commercial Transactions. Operator information, pricing, and cancellation policy.",
  },
};
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        en: "https://gemilab.net/en/tokusho",
        "x-default": "https://gemilab.net/en/tokusho",
      },
    },
  };
}
