...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = locale === "ja" ? "利用規約" : "Terms of Use";
  return {
    title,
    openGraph: { title },
    alternates: {
    ...
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 24px 120px" }}>
      ...
      <div className="article-content">
        {isJa ? (
          <>
            <h2>免責事項</h2>
            <p>Gemini Lab は Google の非公式な情報サイトです。当サイトのコンテンツは情報提供を目的としており、正確性・完全性を保証するものではありません。</p>
            <h2>著作権</h2>
            <p>当サイトに掲載されているオリジナルコンテンツの著作権は、サイト運営者に帰属します。Gemini、Google 等の商標はそれぞれの権利者に帰属します。</p>
            <h2>禁止事項</h2>
          ...
          <>
            <h2>Disclaimer</h2>
            <p>Gemini Lab is an unofficial information site about Google&apos;s products. The content on this site is for informational purposes and does not guarantee accuracy or completeness.</p>
            <h2>Copyright</h2>
            <p>Copyright of original content on this site belongs to the site operator. Trademarks such as Gemini and Google belong to their respective owners.</p>
