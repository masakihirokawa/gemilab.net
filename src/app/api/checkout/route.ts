...
const PLAN_NAMES: Record<string, string> = {
  ...
  "price_1TLBHNEGB5g6A54ojMbzYa9C": "Gemini Lab — 記事単体購入（¥200）",
  "price_1TLBHNEGB5g6A54ozXHw0DSg": "Gemini Lab — Single Article Purchase ($1.50)",
...
const ARTICLE_PRICE_IDS = new Set([
  "price_1TLBHNEGB5g6A54ojMbzYa9C",  // ¥200 JPY (current)
  "price_1TLBHNEGB5g6A54ozXHw0DSg",  // $1.50 USD (current)
