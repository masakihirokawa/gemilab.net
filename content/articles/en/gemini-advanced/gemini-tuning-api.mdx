...
For advanced workflows, explore the [function calling guide](/articles/gemini-api/function-calling-guide) to add tool use to your tuned models, or review [streaming patterns](/articles/gemini-api/streaming-and-chat) for real-time tuned model interactions.
