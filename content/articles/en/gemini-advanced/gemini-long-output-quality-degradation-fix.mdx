...
highlights:
  - "Why Gemini's last sections drift to abstract conclusions, and what readers actually feel when that happens"
  - "A 'pre-declared footer' prompt that finishes the closing line first, freeing Gemini to keep density in the body"
  - "When the three-layer pipeline is worth the extra tokens, and when shorter pieces are better written in one shot"
---
