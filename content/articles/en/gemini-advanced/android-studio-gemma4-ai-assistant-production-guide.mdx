...
highlights:
  - "Build a routing proxy that automatically selects the right Gemma model size based on task type — faster completions without sacrificing review quality"
  - "Fine-tune Gemma 4 on your own codebase using LoRA so the model learns your project's architecture patterns and conventions"
  - "Deploy a reproducible local AI environment for your entire team with Docker Compose, and run automated AI code reviews in GitHub Actions"
---
...
This article covers the production setup I've built for Android development over the past several months.
