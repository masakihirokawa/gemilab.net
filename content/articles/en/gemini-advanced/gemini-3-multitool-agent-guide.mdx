...
author: "Gemini Lab"
premium: true
description: "A hands-on look at Gemini 3 multi-tool agents: combining Built-in Tools with Function Calling, Context Circulation, and parallel tool IDs, with measured latency numbers and the pitfalls I hit in production."
...
<table>
  <thead>
    <tr><th>Model</th><th>Best For</th><th>Relative Cost</th><th>Thinking</th></tr>
  </thead>
  <tbody>
    <tr><td>gemini-3-pro</td><td>Complex reasoning, high-stakes decisions</td><td>High</td><td>✅</td></tr>
    <tr><td>gemini-3-flash</td><td>Production throughput, cost-sensitive</td><td>Low</td><td>✅</td></tr>
    <tr><td>gemini-3-flash-lite</td><td>Simple extraction, high-volume batch</td><td>Very Low</td><td>❌</td></tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr><th>Execution</th><th>3-tool total (median)</th><th>vs. sequential</th></tr>
  </thead>
  <tbody>
    <tr><td>Sequential (for loop)</td><td>3.31s</td><td>1.00x</td></tr>
    <tr><td>Parallel (asyncio.gather)</td><td>1.42s</td><td>0.43x</td></tr>
  </tbody>
</table>
...
For related implementation guidance, see the [Advanced Gemini API Tool Use guide](/articles/gemini-api/gemini-api-tool-use-advanced), the [complete Function Calling guide](/articles/gemini-api/gemini-api-function-calling-complete), and [building an agent loop without ADK](/articles/gemini-advanced/gemini-api-custom-agent-loop-without-adk-production-masterclass).
