...
<table>
  <thead>
    <tr><th>Metric</th><th>Gemini 1.5 Pro</th><th>Gemma 4 31B on Vertex AI</th></tr>
  </thead>
  <tbody>
    <tr><td>Input</td><td>$2.50</td><td>$0.35</td></tr>
    <tr><td>Output</td><td>$10.00</td><td>$1.05</td></tr>
    <tr><td>Max Context</td><td>2M tokens</td><td>256K tokens</td></tr>
    <tr><td>Latency</td><td>2–5s</td><td><1s (on-device)</td></tr>
  </tbody>
</table>
