---
title: "Production-Grade Voice AI Agent with Gemini Live API & Google ADK [2026]"
...
<table>
  <thead>
    <tr><th>Item</th><th>Rate</th><th>Estimated Cost</th></tr>
  </thead>
  <tbody>
    <tr><td>Live API audio input</td><td>$0.70 / 1M tokens</td><td>~$14</td></tr>
    <tr><td>Live API audio output</td><td>$2.80 / 1M tokens</td><td>~$56</td></tr>
    <tr><td>Cloud Run (CPU time)</td><td>$0.00002400/vCPU-sec</td><td>~$24</td></tr>
    <tr><td>Firestore (read/write)</td><td>$0.06–0.18/1M ops</td><td>~$5</td></tr>
    <tr><td><strong>Total</strong></td><td>—</td><td><strong>~$99</strong></td></tr>
  </tbody>
</table>
