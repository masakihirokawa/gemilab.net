...
<table>
  <thead>
    <tr><th>Configuration</th><th>Avg. Latency</th><th>Tokens Used</th><th>Bug Detection Rate</th></tr>
  </thead>
  <tbody>
    <tr><td>No thinking (budget=0)</td><td>2.1s</td><td>~1,200</td><td>61%</td></tr>
    <tr><td>Light thinking (budget=2048)</td><td>4.8s</td><td>~2,800</td><td>78%</td></tr>
    <tr><td>Deep thinking (budget=8192)</td><td>9.3s</td><td>~5,600</td><td>86%</td></tr>
  </tbody>
</table>
