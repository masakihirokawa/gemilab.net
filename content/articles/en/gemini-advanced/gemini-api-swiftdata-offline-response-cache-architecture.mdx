...
| Metric | Target | What to do when it goes red |
| --- | --- | --- |
| Total store size | Under 50 MB | Re-check the binary split-off model |
| Cache hit rate | 30% or higher | Revisit prompt normalization and TTL |
| Single record's share of total hits | Under 10% | The prompt is too coupled to user input |
| Backlog of >30-day-old entries | Under 100 | The launch-time evict job is not running |
