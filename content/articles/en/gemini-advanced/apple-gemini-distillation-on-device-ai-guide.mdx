...
<table>
  <thead>
    <tr><th>Aspect</th><th>Cloud AI</th><th>On-Device AI (Distilled)</th></tr>
  </thead>
  <tbody>
    <tr><td>Latency</td><td>Hundreds of ms to seconds</td><td>Tens of milliseconds</td></tr>
    <tr><td>Privacy</td><td>Data sent to servers</td><td>Data stays on device</td></tr>
    <tr><td>Offline</td><td>Not available</td><td>Fully functional</td></tr>
    <tr><td>Cost</td><td>Per-API-call billing</td><td>Included with device</td></tr>
    <tr><td>Quality</td><td>Highest (full model)</td><td>High (80-95% of teacher)</td></tr>
  </tbody>
</table>
