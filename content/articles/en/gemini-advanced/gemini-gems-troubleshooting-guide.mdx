---
title: "Gemini Gems Not Working: A Complete Troubleshooting Guide"
...
highlights:
  - "Understand why Gems ignore custom instructions and learn the exact writing patterns that get followed reliably"
  - "Get fixes for all 7 known Gems issues: save failures, mid-conversation resets, missing Gems, and more"
  - "Get a battle-tested Gems design template and real-world examples for building high-quality custom Gemini assistants"
---
...
This guide covers the seven most common Gems issues, what's causing each one, and how to fix them — plus a design framework for building Gems that actually behave the way you intended.
