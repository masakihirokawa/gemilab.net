...
To deepen your general API design intuition, [Web API: The Good Parts by Takaaki Mizuno](https://www.amazon.co.jp/dp/4873116864/?tag=pinocchio-22) is a Japanese-language classic that still holds up. LLM APIs differ in some ways from REST APIs, but the chapters on billing design and idempotency translate surprisingly well to the LLM era.
