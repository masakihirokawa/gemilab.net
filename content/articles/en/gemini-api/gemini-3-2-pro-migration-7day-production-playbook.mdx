...
highlights:
  - "Stand up an automated harness that catches prompts that break on 3.2 Pro before any user sees the change — starting on Day 1"
  - "Route 5% of real production traffic to 3.2 Pro for 24 hours and decide on the migration based on measured cost, quality, and latency"
  - "Ship a feature-flag rollback switch that reverts to 2.5 Pro within 5 seconds, so you can move forward confidently without exposing users to risk"
---
