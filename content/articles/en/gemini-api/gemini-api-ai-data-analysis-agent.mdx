...
<table>
  <thead>
    <tr><th>Feature</th><th>Role</th><th>Example</th></tr>
  </thead>
  <tbody>
    <tr><td><strong>Code Execution</strong></td><td>Data processing, statistics, visualization</td><td>Pandas aggregations, Matplotlib charts</td></tr>
    <tr><td><strong>Function Calling</strong></td><td>External resource access</td><td>File loading, DB queries, API calls</td></tr>
    <tr><td><strong>Structured Output</strong></td><td>Result formatting</td><td>JSON-schema-compliant insight reports</td></tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr><th>Operation</th><th>Input Tokens</th><th>Output Tokens</th><th>Flash Cost (est.)</th></tr>
  </thead>
  <tbody>
    <tr><td>CSV load (1,000 rows)</td><td>~5,000</td><td>~500</td><td>~$0.001</td></tr>
    <tr><td>Statistical analysis + code execution</td><td>~2,000</td><td>~3,000</td><td>~$0.003</td></tr>
    <tr><td>Chart generation (Matplotlib)</td><td>~1,000</td><td>~2,000</td><td>~$0.002</td></tr>
    <tr><td>Structured Output</td><td>~3,000</td><td>~1,000</td><td>~$0.002</td></tr>
    <tr><td><strong>Total (single analysis)</strong></td><td><strong>~11,000</strong></td><td><strong>~6,500</strong></td><td><strong>~$0.008</strong></td></tr>
  </tbody>
</table>
