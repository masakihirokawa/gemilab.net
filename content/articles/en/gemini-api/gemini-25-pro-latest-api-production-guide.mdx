...
highlights:
  - "When to use gemini-2.5-pro-latest vs. a pinned version (gemini-2.5-pro-001 etc.) — the honest tradeoff"
  - "Correct retry strategies for 429 / 500 / 503 / 400 / 403 / 404 — with Python code that has held up in production"
  - "Prompt Caching and the Batch API: concrete setup steps and measured cost impact from real services"
---
