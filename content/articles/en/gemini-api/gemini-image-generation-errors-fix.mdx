---
title: "Five Errors That Break Gemini Image Generation — From 429s to Safety Filters"
slug: "gemini-image-generation-errors-fix"
category: "gemini-api"
level: "intermediate"
date: "2026-03-26T20:00"
noindex: true
author: "Gemini Lab"
description: "Causes and implementation-level fixes for the Gemini API image generation errors you are most likely to hit: 429 quota exhaustion, safety filter blocks, and corrupted output."
tags: ["gemini", "image-generation", "troubleshooting", "429", "error", "imagen"]
premium: false
---

## Why Image Generation Suddenly Stopped Working

Code that generated images fine yesterday now returns 429 RESOURCE_EXHAUSTED on every call. Since December 2025, when Google changed the free tier's image-per-minute limits, this has become one of the most common reports.

Quota is not the only culprit. Safety filter blocks, corrupted output data, wrong model identifiers, and creeping generation times each fail in their own way. Below are the five errors you are most likely to hit, with **implementation patterns** for resolving each one.
...
<table>
  <thead>
    <tr><th>Original</th><th>Rewritten</th><th>Success Rate</th></tr>
  </thead>
  <tbody>
    <tr><td>"People fighting"</td><td>"Action movie poster fight scene"</td><td>↑ Higher</td></tr>
    <tr><td>"Graphic violence"</td><td>"Dramatic action scene, painterly style"</td><td>↑ Higher</td></tr>
    <tr><td>"Celebrity look-alike"</td><td>"Character in the style of [celebrity]"</td><td>↑ Higher</td></tr>
    <tr><td>"Real person photo"</td><td>"Portrait illustration inspired by..."</td><td>↑ Higher</td></tr>
  </tbody>
</table>
