...
Start by grabbing an API key from Google AI Studio ([aistudio.google.com](https://aistudio.google.com/)). Once you have it, store it as an environment variable — never hardcode API keys in your source code.
