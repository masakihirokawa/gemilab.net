...
**Q1: Does Gemini TTS support Japanese?**

A: Yes. Gemini 2.5 Flash supports 100+ languages including Japanese, with high-quality speech output.

**Q2: Can I use generated audio commercially?**

A: Yes, provided you comply with the Gemini API terms of service. Commercial uses like podcast sales and film narration are permitted.

**Q3: What should I do if my API key is compromised?**

A: Go to your Google AI Studio dashboard and disable the compromised key immediately. Generate a new one.

**Q4: Is there free access for educational use?**

A: Yes. Google Research offers grants for non-profit educational institutions. Visit [Google Research Education](https://research.google.com/edu) for details.
