...
For broader Node.js fundamentals around streams and async behavior — useful when reading the new `generateContentStream` source — [Node.js Design Patterns by Mario Casciaro](https://www.amazon.co.jp/dp/1839214112/?tag=pinocchio-22) is the book I keep coming back to.
