...
If you want to deepen the underlying API design intuition, [Web API: The Good Parts (by Takaaki Mizuno, Japanese only)](https://www.amazon.co.jp/dp/4873116864/?tag=pinocchio-22) is the book that helped me internalize "decompose the step, kill the downtime."
