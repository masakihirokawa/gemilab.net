...
For a refresher on Grounding fundamentals, see the [Grounding with Google Search Complete Implementation Guide](/articles/gemini-api/gemini-api-grounding-google-search-production-guide). To dive deeper into schema design, check out the [Gemini Structured Output Practical Guide](/articles/gemini-advanced/gemini-structured-output-production-guide).
