...
For production-grade LLM application architecture, [Hands-On Large Language Models](https://www.amazon.co.jp/dp/B0CX2ZN1PP/?tag=pinocchio-22) by Jay Alammar and Maarten Grootendorst covers the broader context of building reliable systems around LLM APIs — a useful companion to this guide if you're moving from prototype to real product.
