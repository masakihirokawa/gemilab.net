...
I'm Masaki Hirokawa, a contemporary artist and indie app developer. I've been shipping mobile apps as a single-person operation since 2014, and my wallpaper apps have accumulated more than 50 million downloads across the App Store and Google Play. Recently I built a pipeline that generates onboarding copy for six apps with Gemini 2.5 Flash and ships it through Firebase Remote Config with a gradual rollout. What used to take several days of back-and-forth with a translation service now runs in tens of seconds from an Apps Script trigger.
