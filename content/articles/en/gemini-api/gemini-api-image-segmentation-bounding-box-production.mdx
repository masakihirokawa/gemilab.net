...
For deeper grounding in classical CV alongside this, I still recommend [Programming Computer Vision with Python by Jan Erik Solem](https://www.amazon.co.jp/dp/4873116074/?tag=pinocchio-22) — knowing what's happening behind the curtain makes diagnosing bad detections a lot more productive.
...
For the surrounding production concerns, [the Gemini API rate-limiting and quota-management guide](/en/articles/gemini-api/gemini-api-rate-limiting-quota-management-production-guide) and [the streaming-cancel + AbortController guide](/en/articles/gemini-api/gemini-api-streaming-cancel-abortcontroller-guide) round out the playbook nicely.
