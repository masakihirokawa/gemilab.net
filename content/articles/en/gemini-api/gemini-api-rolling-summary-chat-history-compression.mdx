...
For a deeper grounding in LLM application architecture, [Building LLM Apps (Valentina Alto)](https://www.amazon.co.jp/dp/1835462316/?tag=pinocchio-22) covers memory management, token accounting, and prompt design with examples that translate cleanly to Gemini even though the book leans toward OpenAI.
