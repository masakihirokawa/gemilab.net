...
<table>
  ...
  <tbody>
    <tr><td>Monthly churn</td><td>≤ 5%</td><td>Above 7% → revisit onboarding</td></tr>
    <tr><td>Average LTV</td><td>≥ 20× plan price</td><td>Low LTV → fix the onboarding win</td></tr>
    <tr><td>Gross margin</td><td>≥ 70%</td><td>API management + quotas</td></tr>
    <tr><td>NPS</td><td>≥ +20</td><td>Run quarterly</td></tr>
    <tr><td>Top 3 acquisition channels</td><td>—</td><td>SEO / word of mouth / social</td></tr>
    <tr><td>Monthly API cost per user</td><td>≤ 25% of plan price</td><td>Over → redesign quotas</td></tr>
  </tbody>
</table>
