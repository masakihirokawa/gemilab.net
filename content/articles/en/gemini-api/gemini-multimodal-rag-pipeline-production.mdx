---
title: "Multimodal RAG with Gemini API — Cross-Format Search over Images, PDFs, and Video"
...
What follows traces document processing, vector index construction, and the search-generation pipeline in working Python. It assumes familiarity with [Function Calling fundamentals](/articles/gemini-advanced/function-calling-guide) — start there if agent tool use is new to you.
