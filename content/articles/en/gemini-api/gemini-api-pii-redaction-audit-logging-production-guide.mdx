...
If you want to ground all of this in a broader web-security mindset — which is what privacy reviewers really look for — [The Web Application Hacker's Handbook (Stuttard, Pinto)](https://www.amazon.co.jp/dp/1118026470/?tag=pinocchio-22) is still the book I recommend. PII handling sits inside the larger picture of input validation and least-privilege design, and that book is the reference text most security professionals share a vocabulary from.
