...
Get started by creating your API key at [Google AI Studio](https://aistudio.google.com/), then explore more advanced retrieval patterns with the [Gemini Deep Research Agent](/en/articles/gemini-api/deep-research-agent-guide).
