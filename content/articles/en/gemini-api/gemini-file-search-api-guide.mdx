...
Yes. The API supports Gemini 2.5 Pro, Gemini 2.5 Flash, and Gemini 3.x models. For the highest retrieval accuracy and reasoning quality, Gemini 3.1 Pro Preview tends to perform best. Check the [Gemini API quickstart]((/articles/gemini-api/gemini-api-quickstart) for the latest supported model list.
