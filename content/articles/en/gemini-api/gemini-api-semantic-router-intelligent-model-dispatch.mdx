...
For the broader question of which model to pick by default, see the [Gemini Model Selection Guide](/en/articles/gemini-basics/gemini-model-selection-guide).
...
For deeper reading, I recommend "[Designing Machine Learning Systems](https://www.amazon.co.jp/dp/4814400799/?tag=pinocchio-22)" — a clear treatment of how to build production ML systems end-to-end.
