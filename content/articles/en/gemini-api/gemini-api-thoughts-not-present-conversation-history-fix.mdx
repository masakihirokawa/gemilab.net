---
title: "Fixing 'Thoughts must be present in conversation history' in Gemini API: A Practical Guide to Thought Signatures in Multi-Turn Tool Calls"
...
If you want to step back and design the long-running side of agent state more deliberately, [Implementing Domain-Driven Design (Vaughn Vernon)](https://www.amazon.co.jp/dp/4814401973/?tag=pinocchio-22) is a solid grounding in passing state between long-lived participants — useful framing for thinking-state continuity even though it predates LLM agents.
