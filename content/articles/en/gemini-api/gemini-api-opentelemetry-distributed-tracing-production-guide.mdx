...
For a deeper grounding in the design decisions behind OpenTelemetry itself — semantic conventions, SDK architecture, and Collector pipelines — I found [Learning OpenTelemetry by Ted Young and Austin Parker](https://www.amazon.co.jp/dp/1098147189/?tag=pinocchio-22) especially helpful when sharpening the production-readiness judgments this article relies on.
