...
The simplest approach is exporting test results as CSV or JSON and version-controlling them in a Git repository. Include variant names, timestamps, and evaluation scores so you can track prompt change history alongside quality trends. For more sophisticated setups, combine [Gemini API's logging features]((/articles/gemini-api/gemini-api-logging-datasets) with periodic batch evaluations.
