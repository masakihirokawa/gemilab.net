...
highlights:
  - "Four patterns that cause Gemini API cost runaways, and the metrics you need to diagnose them"
  - "A three-layer guardrail (per-user, daily total, monthly total) with a pragmatic Redis implementation"
  - "An anomaly-detection setup that notifies you before you see the invoice — not after"
---
