...
During the ten days of measurement there was exactly one morning when only the Flash call returned a 503. The routine survived on Pro's summary alone that day, and I was glad these few lines of insurance were in from the start.
