...
<table>
  <thead>
    <tr><th>Setting</th><th>Streaming</th><th>Max duration</th><th>Notes</th></tr>
  </thead>
  <tbody>
    <tr><td><code>runtime = "edge"</code></td><td>Native, stable</td><td>25 s on Hobby, 300 s on Pro</td><td>Built on Web Streams; pairs well with fetch-based code</td></tr>
    <tr><td><code>runtime = "nodejs"</code></td><td>Works with <code>force-dynamic</code></td><td>10 s on Hobby, up to 900 s on Pro</td><td>Omitting <code>dynamic = "force-dynamic"</code> causes static generation</td></tr>
  </tbody>
</table>
