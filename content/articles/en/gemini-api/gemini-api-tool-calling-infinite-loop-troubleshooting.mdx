...
For the broader design mindset behind tool-using LLM systems, I found [Building AI-Powered Search Applications with LangChain (Yoshida & Oshima)](https://www.amazon.co.jp/dp/4297138395/?tag=pinocchio-22) genuinely useful. It is framed around other providers, but the chapters on controlling tool invocation and designing logs apply cleanly to Gemini.
