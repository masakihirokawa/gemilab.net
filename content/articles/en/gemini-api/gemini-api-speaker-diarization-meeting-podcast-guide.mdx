---
title: "Speaker Diarization with Gemini API: A Practical Guide for Meetings and Podcasts"
...
For deeper background on speech processing in general, [Speech and Language Processing (Jurafsky & Martin)](https://www.amazon.co.jp/dp/B07YJ5N9LD/?tag=pinocchio-22) is the reference I keep coming back to — it complements LLM-based approaches with the classical feature extraction and speaker embedding theory you'll need when Gemini hits its limits.
