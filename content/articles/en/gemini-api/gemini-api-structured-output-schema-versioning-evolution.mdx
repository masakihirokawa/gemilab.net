...
highlights:
  - "Four kinds of schema change (add, type-change, rename, retire) and the safe procedure for each"
  - "A three-layer split — Gemini schema, stored schema, domain model — that keeps changes from cascading"
  - "Phased migration patterns for existing data, plus the Gemini-specific pitfall of enum narrowing and how to avoid it"
---
