...
highlights:
  - "Three failure patterns that bite production even with Gemini's structured output mode — and the root cause"
  - "A three-stage defense: Zod/Pydantic validation + repair prompts + graceful degradation"
  - "Schema management rules from my real repo and the numbers after one month of operation"
---
