...
highlights:
  - "Four evaluation lenses to look at Gemini responses in production, with the exact judge prompts I use"
  - "How to avoid the self-evaluation bias of LLM-as-a-judge by routing across model families"
  - "A sampling strategy that keeps evaluation cost at roughly 15% of generation cost without missing outliers"
---
