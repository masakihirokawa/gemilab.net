...
| Use case | Request cadence | Recommended TTL | display_name refresh |
|---|---|---|---|
| User-triggered (e.g. wallpaper app) | seconds to minutes | 24h | monthly |
| Nightly batch (bulk tagging) | 1× / day | 2h | daily (before batch) |
| Weekly aggregation (reports) | 1× / week | 1h | weekly |
| Demo / debugging | irregular | 1h | delete immediately |
...
| Task | Model | System prompt size | TTL | Context Cache | Implicit Cache |
|---|---|---|---|---|---|
| Customer support bot | Pro | ~10K tokens | 12h | Required | Bonus |
| Wallpaper tagging batch | Flash | ~4K tokens | 2h | Recommended | Bonus |
| Short poem generation (user-triggered) | Flash | ~8K tokens | 24h | Required | Bonus |
| Document QA | Pro | ~20K tokens | 12h | Required | Bonus |
| Code review bot | Pro | ~6K tokens | 6h | Required | Bonus |
| Demo / debugging | Flash | any | 1h | Optional | Optional |
