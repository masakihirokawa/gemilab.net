...
For a deeper dive into Agent Mode capabilities, check out our [Gemini Code Assist Agent Mode Complete Guide]((/articles/gemini-dev/gemini-code-assist-agent-mode-guide).
...
Begin by using Code Assist in your daily development, then try Agent Mode for repetitive tasks and boilerplate-heavy work. If you're new to Gemini's fundamentals, our [Gemini Code Assist Getting Started Guide]((/articles/gemini-dev/gemini-code-assist-guide) is a great starting point. VS Code users may also want to check out our [Gemini × VS Code AI Coding Environment Setup Guide]((/articles/gemini-dev/gemini-vscode-ai-coding-complete-setup-guide).
