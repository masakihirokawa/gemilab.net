...
For detailed Plan Mode usage, see "[Gemini CLI Plan Mode Guide](/en/articles/gemini-dev/gemini-cli-plan-mode)".
...
For more details on rate limiting, see "[Gemini API 429 Error and Quota Troubleshooting](/en/articles/gemini-api/gemini-api-quota-429-error-troubleshooting)".
...
- **[Gemini CLI Complete Guide](/en/articles/gemini-dev/gemini-cli-guide)** — In-depth command reference and configuration options
- **[Gemini CLI Plan Mode Guide](/en/articles/gemini-dev/gemini-cli-plan-mode)** — Advanced planning features
