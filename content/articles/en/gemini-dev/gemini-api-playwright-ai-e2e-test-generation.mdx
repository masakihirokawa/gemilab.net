...
Bundle multiple page test generation requests together to reduce API call frequency. Leveraging Gemini's [Batch Processing API]((/articles/gemini-api/gemini-batch-processing-api-guide) can achieve an additional 50% cost reduction.
