...
If the Rust patterns in this guide surface gaps in your background with async Rust and the borrow checker, [Programming Rust, 2nd Edition (Blandy, Orendorff, Tindall)](https://www.amazon.co.jp/dp/4873119782/?tag=pinocchio-22) covers lifetimes, async/await, and the `tokio` runtime in the depth that Tauri backend development genuinely requires.
