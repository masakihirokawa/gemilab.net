...
<table>
  <thead>
    <tr><th>Aspect</th><th>Build Mode</th><th>Direct Gemini API</th></tr>
  </thead>
  <tbody>
    <tr><td>Audience</td><td>Prototyping, low-code approach</td><td>AI integration in existing projects</td></tr>
    <tr><td>Output</td><td>Complete application</td><td>API responses (text, images, etc.)</td></tr>
    <tr><td>Customization</td><td>Prompts + code editing</td><td>Full code control</td></tr>
    <tr><td>Firebase</td><td>Auto-provisioning</td><td>Manual setup</td></tr>
    <tr><td>Deployment</td><td>One-click (Antigravity)</td><td>Your own infrastructure</td></tr>
  </tbody>
</table>
