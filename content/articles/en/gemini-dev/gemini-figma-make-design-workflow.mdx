...
**Q: Can I skip Figma Make and just use Gemini?**

A: Technically possible, but impractical. Gemini outputs text, making it hard to visually compare multiple UI variations. Figma Make lets designers see options side-by-side—crucial for decision-making.

**Q: Who owns the copyright of generated designs?**

A: Both Gemini API and Figma Make grant users ownership of generated outputs. Commercial use, modification, and redistribution are permitted under their terms. Always review the specific API terms of service.

**Q: What if I have an existing design system?**

A: Customize Figma Make scenarios to reference existing components. You can configure "automatically insert existing button component during generation," maintaining consistency with your brand.
