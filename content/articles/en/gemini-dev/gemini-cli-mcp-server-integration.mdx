---
title: "Gemini CLI with MCP Servers: A from File I/O to Database Queries"
slug: "gemini-cli-mcp-server-integration"
category: "gemini-dev"
level: "intermediate"
premium: false
...
If you want to build a custom MCP server for your own tooling, the [Gemini API Custom MCP Server TypeScript Guide](/en/articles/gemini-dev/gemini-api-custom-mcp-server-typescript) walks through the full implementation.
