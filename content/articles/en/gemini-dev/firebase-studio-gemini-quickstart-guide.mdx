...
For more advanced AI tooling patterns, check out the [Gemini API Custom MCP Server TypeScript Implementation Guide](/en/articles/gemini-dev/gemini-api-custom-mcp-server-typescript).
