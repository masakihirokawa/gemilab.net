---
title: "Sharpening Gemini CLI and Code Assist Context with .geminiignore — A Practical Guide"
...
For a deeper foundation in context design as a general LLM engineering topic, [Building LLM-Powered Applications by Valentina Alto](https://www.amazon.co.jp/dp/1835462316/?tag=pinocchio-22) is one of the more grounded resources I've used. The chapters on retrieval and context construction transfer cleanly to thinking about what to keep and what to drop in `.geminiignore`.
