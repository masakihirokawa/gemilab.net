---
title: "Gemini in Google Workspace 2026: New Features in Docs, Sheets, Slides & Drive"
...
---
In March 2026, Google shipped a major update to **Gemini in Google Workspace** — one that moves the AI assistant beyond simple text generation toward something more like an intelligent layer connecting your entire organization's knowledge. This piece looks at what actually shipped and how to put it to work—useful whether you want to streamline your own workflow or rebuild similar features inside your own apps.
