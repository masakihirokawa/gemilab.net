...
<table>
  <thead>
    <tr><th>Category</th><th>After 6/18</th><th>Action</th></tr>
  </thead>
  <tbody>
    <tr><td>Personal Gemini CLI interactive use</td><td>Stops</td><td>Move to Antigravity CLI</td></tr>
    <tr><td>Code Assist IDE extension (personal)</td><td>Stops</td><td>Move to Antigravity / API</td></tr>
    <tr><td>Code Assist for GitHub</td><td>New installs stop</td><td>Move existing wiring to the API</td></tr>
    <tr><td>Gemini API (key / Vertex)</td><td>Continues</td><td>Keep, and pull automation toward direct calls</td></tr>
  </tbody>
</table>
