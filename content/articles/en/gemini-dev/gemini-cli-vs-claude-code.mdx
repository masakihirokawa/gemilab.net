...
<table>
  <thead>
    <tr><th>Category</th><th>Gemini CLI</th><th>Claude Code</th></tr>
  </thead>
  <tbody>
    <tr><td>Model</td><td>Gemini 3.1 Pro / Flash</td><td>Claude Opus 4.6</td></tr>
    <tr><td>Context Window</td><td>Up to 1M tokens</td><td>Up to 200K tokens</td></tr>
    <tr><td>Free Tier</td><td>Yes (generous)</td><td>No (paid only)</td></tr>
    <tr><td>Estimated Monthly Cost</td><td>Free–low cost</td><td>$20+/month (usage-based)</td></tr>
    <tr><td>Autonomous Execution</td><td>Moderate</td><td>High</td></tr>
    <tr><td>Google Ecosystem</td><td>Excellent</td><td>Standard</td></tr>
    <tr><td>Code Quality</td><td>Good</td><td>Excellent</td></tr>
    <tr><td>Setup Complexity</td><td>Easy (via npm)</td><td>Easy (via npm)</td></tr>
  </tbody>
</table>
