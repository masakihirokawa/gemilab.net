...
If you're new to Gemini, you might want to start with our [Gemini AI Beginner's Guide 2026]((/articles/gemini-basics/gemini-ai-beginner-guide-2026) for an overview of the platform.
...
The side panel works across Gmail, Google Docs, and Sheets. For more on using Gemini with spreadsheets, check out our [Google Sheets × Gemini AI Practical Guide]((/articles/gemini-workspace/gemini-google-sheets-ai-data-analysis).
...
If you combine email insights with presentation work, you can seamlessly turn email content into slide decks. See our [Google Slides × Gemini AI Practical Guide]((/articles/gemini-workspace/gemini-google-slides-ai-presentation-guide) for more.
