...
highlights:
  ...
  - "Deploy a zero-touch weekly reporting pipeline — from data collection to Slack notification and PDF export — running on Cloud Scheduler with no manual effort"
---
