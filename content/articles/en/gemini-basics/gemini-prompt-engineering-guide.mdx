...
For more details, see the [Google AI Studio Guide]((/articles/gemini-dev/google-ai-studio-guide).
...
Start by experimenting with System Instructions in Google AI Studio, then layer in Few-shot and CoT as needed. For API implementation details, see the [Gemini API Quickstart]((/articles/gemini-api/gemini-api-quickstart).
