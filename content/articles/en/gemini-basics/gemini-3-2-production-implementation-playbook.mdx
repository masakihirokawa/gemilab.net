...
highlights:
  - "A 5-minute decision framework for choosing between Pro, Flash, and Nano — with my actual production routing examples"
  - "Production patterns for Streaming, Function Calling, and Multimodal APIs (TypeScript code)"
  - "Honest comparisons against Claude and GPT — where Gemini 3.2 dominates, where it falls behind"
---
