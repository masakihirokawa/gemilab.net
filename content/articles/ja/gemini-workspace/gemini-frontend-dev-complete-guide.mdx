...
[入門記事](/articles/gemini-workspace/gemini-figma-lp-creation-1hour)では Gemini の Canvas モードを使った LP 制作の基本ワークフローを解説しましました。本記事では、そこからさらに一歩踏み込んで、**Gemini を本格的なフロントエンド開発ツールとして活用する方法**を体系的に解説します。
