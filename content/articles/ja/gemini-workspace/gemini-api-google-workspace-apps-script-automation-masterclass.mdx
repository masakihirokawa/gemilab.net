---
title: "Google Workspace × Gemini API 業務自動化の運用ノート — Apps Script 実装パターン12選と本番設計"
...
author: "Gemini Lab"
description: "Gemini API と Google Apps Script で Gmail・Docs・Sheets・Calendar を横断する業務自動化を組む実装パターン12選。4サイト運用とアプリ問い合わせ対応で踏んだ落とし穴を、429の握りつぶし・JSONフェンス・6分制限・モデル振り分けの実測付きで整理しました。"
