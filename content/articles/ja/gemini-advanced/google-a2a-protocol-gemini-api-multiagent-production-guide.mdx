...
事前知識として、[Google ADK マルチエージェントアーキテクチャ完全ガイド](/articles/gemini-advanced/google-adk-multiagent-architecture-production-masterclass) と [Gemini API Function Calling 完全ガイド](/articles/gemini-api/gemini-api-function-calling-complete) を読んでおくと理解が深まります。
