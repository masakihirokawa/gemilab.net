...
<table>
  <thead>
    <tr><th>機能</th><th>収益化での活用</th><th>Gemini の強み</th></tr>
  </thead>
  <tbody>
    <tr><td>マルチモーダル入力</td><td>画像/動画解析サービス</td><td>100万トークンのコンテキストウィンドウ</td></tr>
    <tr><td>Function Calling</td><td>外部API連携の自動化</td><td>並列実行・ネイティブサポート</td></tr>
    <tr><td>コンテキストキャッシュ</td><td>繰り返し処理のコスト削減</td><td>キャッシュ料金が入力の1/4</td></tr>
    <tr><td>Grounding</td><td>検索連携で最新情報を提供</td><td>Google検索との統合</td></tr>
    <tr><td>バッチAPI</td><td>大量処理の低コスト実行</td><td>50%割引の非同期処理</td></tr>
  </tbody>
</table>
