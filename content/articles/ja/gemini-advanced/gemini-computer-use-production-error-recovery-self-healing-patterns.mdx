...
このレイヤーを順に組み立てていきます。なお、Computer Use そのものの基本実装は[Gemini 3 Pro Computer Use Tool 完全解説](/articles/gemini-advanced/gemini-3-pro-computer-use-browser-automation)と[Gemini 3.1 Computer Use 完全ガイド](/articles/gemini-advanced/gemini-31-computer-use-complete-guide)で書いていますので、ここではエージェントループのコード自体は最小限にとどめ、回復ロジックに集中します。
