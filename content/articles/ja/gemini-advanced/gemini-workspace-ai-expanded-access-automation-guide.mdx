...
2026年3月、GoogleはGemini Workspaceの新アドオン「**AI Expanded Access**」をローンチしましました。このオプション機能により、Workspace内のすべてのアプリケーション（Docs、Sheets、Slides、Gmail）にGemini 3 Proの高度な推論機能を統合でき、複雑なビジネスプロセスの自動化が格段に容易になります。
