...
<table>
  <thead>
    <tr><th>項目</th><th>単価</th><th>1,000セッション/月の試算</th></tr>
  </thead>
  <tbody>
    <tr><td>Gemini Live API（音声入力）</td><td>$0.70/100万トークン</td><td>〜$14</td></tr>
    <tr><td>Gemini Live API（音声出力）</td><td>$2.80/100万トークン</td><td>〜$56</td></tr>
    <tr><td>Cloud Run（実行時間）</td><td>$0.00002400/vCPU秒</td><td>〜$24</td></tr>
    <tr><td>Firestore（読み書き）</td><td>$0.06〜0.18/100万ops</td><td>〜$5</td></tr>
    <tr><td><strong>合計</strong></td><td>—</td><td><strong>〜$99</strong></td></tr>
  </tbody>
</table>
