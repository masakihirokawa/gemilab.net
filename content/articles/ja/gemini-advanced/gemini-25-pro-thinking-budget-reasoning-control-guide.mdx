...
highlights:
  - "Thinking Budget（0〜24576トークン）の最適値をタスク種別ごとに解説。設定値と応答品質・コストのトレードオフ"
  - "思考プロセス（thinking_parts）を取得して品質チェックに活用する実装パターン"
  - "数学・コード・複雑な分析タスクそれぞれで Thinking を最大活用するプロンプト設計の実例"
---
