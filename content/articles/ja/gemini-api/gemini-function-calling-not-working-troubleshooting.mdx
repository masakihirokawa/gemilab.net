---
title: "Gemini Function Calling が呼び出されない — 5つの症状から原因を特定する"
...
author: "Gemini Lab"
description: "Gemini APIのFunction Calling（ツール呼び出し）が動かない・エラーになる問題を症状別に整理。スキーマ定義ミス・モデル選択・レスポンス解析など原因別に解決手順をコード例付きで紹介します。"
