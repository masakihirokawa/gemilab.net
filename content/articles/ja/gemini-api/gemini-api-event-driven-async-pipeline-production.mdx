...
分散システム設計の理論面までさかのぼって学びたい方には、Google のエンジニア Brendan Burns 氏が書いた[『Designing Distributed Systems』（Brendan Burns 著）](https://www.amazon.co.jp/dp/4873118751/?tag=pinocchio-22)が参考になります。本稿のアーキテクチャパターンが、より普遍的な設計原則のどこから来ているのかが見えてきます。
