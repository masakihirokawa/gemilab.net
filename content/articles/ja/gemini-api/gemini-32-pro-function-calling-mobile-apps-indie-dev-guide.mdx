...
highlights:
  - "Gemini 3.2 Pro の Function Calling で iOS/Android アプリに「意図を読む」動的機能を追加でき、アプリ更新なしで機能拡張できるようになる"
  - "SwiftUI と Jetpack Compose それぞれで動作確認済みのコード例（Retry・フォールバック込み）を入手できる"
  - "5,000 万 DL 超の個人開発事業で実証した「コスト設計・エラー設計・段階ロールアウト」の 3 つの本番判断基準を習得できる"
---
