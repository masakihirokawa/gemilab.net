...
noindex: true
author: "Gemini Lab"
description: "generationConfig に seed を指定しても Gemini API の出力が毎回変わる原因を整理しました。seed だけでは決定論にならない理由、まず確認すべき3つの設定、壁紙アプリの分類パイプラインで実践している「ほぼ決定論」を確保する運用パターンを紹介します。"
