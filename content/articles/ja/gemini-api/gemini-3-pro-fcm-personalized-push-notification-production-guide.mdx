...
技術的に深掘りしたい方には、本記事の Cloud Functions 実装パターンを学ぶ際に [『Pythonによる新しいデータ分析の教科書』（寺田 学・辻 真吾・鈴木 たかのり・福島 真太朗）](https://www.amazon.co.jp/dp/4798178861/?tag=pinocchio-22) の第 5〜6 章で扱われている、外部 API を非同期で扱うパターンが参考になります。私自身も Cloud Functions のリトライ設計を組むときに何度か読み返した一冊です。
