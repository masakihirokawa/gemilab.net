...
author: "Gemini Lab"
description: "Gemini API のレート制限・タイムアウト・部分失敗に強いワークフローを、Inngest の durable execution で組む本番ガイドです。最小構成から fan-out / fan-in の並列処理、人間の承認待ち、予算ガードレール、dead-letter と監視まで進めます。"
