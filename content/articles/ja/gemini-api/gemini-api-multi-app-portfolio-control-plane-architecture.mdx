...
<table>
  <thead>
    <tr><th>レイヤ</th><th>役割</th><th>主な実装</th></tr>
  </thead>
  <tbody>
    <tr><td>Config</td><td>どのアプリにどのモデル設定を渡すか</td><td>Firebase Remote Config（条件付き値配信）</td></tr>
    <tr><td>Routing</td><td>リクエストの実際の宛先決定とフォールバック</td><td>Cloudflare Workers（軽量中継）</td></tr>
    <tr><td>Telemetry</td><td>usage_metadata の収集と日次集計</td><td>BigQuery + Google Sheets（按分レポート）</td></tr>
  </tbody>
</table>
