...
<table>
  <thead>
    <tr><th>ユースケース</th><th>Flash</th><th>Pro</th><th>判断理由</th></tr>
  </thead>
  <tbody>
    <tr><td>JSON・XML 生成</td><td>⭐⭐⭐⭐⭐</td><td>⭐⭐⭐⭐</td><td>Flash で十分な品質、コスト優位</td></tr>
    <tr><td>コード補完（シンプル）</td><td>⭐⭐⭐⭐⭐</td><td>⭐⭐⭐⭐</td><td>Flash の推論で対応可能</td></tr>
    <tr><td>テキスト要約</td><td>⭐⭐⭐⭐</td><td>⭐⭐⭐⭐</td><td>要約品質は Flash で十分</td></tr>
    <tr><td>複雑なロジック推論</td><td>⭐⭐</td><td>⭐⭐⭐⭐⭐</td><td>Pro の探索能力が必須</td></tr>
    <tr><td>医療・法務判定</td><td>⭐⭐</td><td>⭐⭐⭐⭐⭐</td><td>責任度が高い、Pro 推奨</td></tr>
    <tr><td>多言語ニュアンス解析</td><td>⭐⭐⭐</td><td>⭐⭐⭐⭐⭐</td><td>言語依存性は Pro が優秀</td></tr>
    <tr><td>画像解析（図表）</td><td>⭐⭐⭐⭐</td><td>⭐⭐⭐⭐</td><td>Flash で充分、コスト優位</td></tr>
    <tr><td>自動採点・評価</td><td>⭐⭐⭐</td><td>⭐⭐⭐⭐⭐</td><td>一貫性と精度は Pro が上</td></tr>
  </tbody>
</table>
