---
title: "Gemini Embedding API × Pinecone でRAGシステムを本番構築する"
slug: "gemini-api-pinecone-rag-production"
category: "gemini-api"
level: "intermediate"
premium: false
...
さらに高度なRAGパターン（マルチモーダル対応・リランキング・ハイブリッド検索）を学びたい方には、[Gemini APIマルチモーダルRAGパイプライン構築ガイド](/articles/gemini-api/gemini-multimodal-rag-pipeline-production) がおすすめです。
