...
author: "Gemini Lab"
description: "gemini-2.5-pro-latest を使った API 開発のテクニックを一通り整理しました。他モデルとの使い分け、Python SDK の実装例、ストリーミング生成、Function Calling、マルチモーダル入力、System Instructions と安全設定まで扱います。"
