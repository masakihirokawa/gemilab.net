...
### 3. ルート embedding は陳腐化する。月 1 回の再生成を推奨
...
本記事のテーマをさらに深めたい方には「[LLM を活用したシステム設計（Eugene Yan 著）](https://www.amazon.co.jp/dp/4814400799/?tag=pinocchio-22)」（邦訳）がおすすめです。本番 ML システムの設計原則が体系的に学べます。お読みいただきありがとうございました。
