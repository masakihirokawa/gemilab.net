...
2026年3月、Google DeepMind は **Lyria 3 Pro**（`lyria-3-pro-preview`）を Gemini API のパブリックプレビューとして公開しましました。従来の Lyria 3 Clip が最大30秒のクリップ生成に特化していたのに対し、Lyria 3 Pro は**約3分のフルレングス楽曲**を生成できる初めてのモデルです。
