...
Gemini 2.5 Flash を使用した場合、1,000 文字の翻訳で約 0.01〜0.02 ドル程度です。バッチ翻訳では[コンテキストキャッシュ](/articles/gemini-api/gemini-api-context-caching-cost-optimization)を使えば、同一プロジェクト内の繰り返しコンテンツに対するコストを大幅に削減できます。
