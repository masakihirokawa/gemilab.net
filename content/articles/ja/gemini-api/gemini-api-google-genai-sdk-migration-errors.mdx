...
書籍で体系的にキャッチアップしたい方には、[実践 Node.js プログラミング第2版（廣戸裕大ほか）](https://www.amazon.co.jp/dp/4295015520/?tag=pinocchio-22) が SDK レイヤーの設計思想を理解するのに役立ちます。Node.js のストリームや非同期処理の感覚を再確認しておくと、新 SDK の `generateContentStream` の挙動も腑に落ちやすくなります。
