...
author: "Gemini Lab"
description: "Gemini の Live Translation / Speech-to-Speech API でリアルタイム多言語音声翻訳アプリを作る実践ガイドです。WebSocket ベースの通信設計、話者認識と文脈保持、音声合成の統合、React Native クライアント実装まで解説します。"
