...
noindex: true
author: "Gemini Lab"
description: "Sentry と Gemini API を組み合わせ、プロンプトの破綻や安全フィルタ発火、トークン超過といった LLM 特有の失敗を本番で観測するパイプラインを構築します。クライアントラッパー、成功に見える失敗を捕捉するインスペクタ、PII を守る before_send まで実装します。"
