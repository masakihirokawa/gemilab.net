...
2026年3月、Google は Personal Intelligence 機能を全米ユーザーに展開しましました。Gemini が Gmail、Google Photos、カレンダーなどの個人データに接続し、ユーザーごとにカスタマイズされた回答を返す仕組みです。AI Mode in Search、Gemini アプリ、Gemini in Chrome の3つのインターフェースから利用できます。
...
2026年3月、Google は Gemini と Google Workspace の統合を大幅に強化しましました。Docs、Sheets、Slides、Drive に Gemini が直接アシストする機能がベータ展開されています。
