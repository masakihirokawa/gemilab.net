...
author: "Gemini Lab"
description: "Google Agent Development Kit（ADK）を初めて触る方向けのハンズオンです。環境構築、フォルダ構成、エージェント本体の実装、adk web での起動と会話までを30分で完走できるよう、Runner や Session などの用語のつまずきも含めて案内します。"
