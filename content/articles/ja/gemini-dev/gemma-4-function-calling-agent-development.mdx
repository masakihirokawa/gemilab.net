...
noindex: true
author: "Gemini Lab"
description: "Gemma 4 の Function Calling を使ったエージェント開発で最初にぶつかる壁を整理しました。tools パラメータによる関数定義、JSON 解析と型安全性の落とし穴、システム指示との相互作用、26B MoE と 31B Dense のどちらを使うかまで解説します。"
