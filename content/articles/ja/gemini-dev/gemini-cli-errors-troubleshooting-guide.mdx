---
title: "Gemini CLI が起動しない・認証が通らないときに見る場所"
...
author: "Gemini Lab"
description: "Gemini CLI が起動しない、認証が通らないときの確認ポイントをまとめました。npm インストールの失敗、command not found、Plan Mode が使えない、gVisor サンドボックス、プロキシ、429 レート制限まで、セットアップ段階の詰まりを順に解消します。"
