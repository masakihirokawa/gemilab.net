---
title: "Gemini API × Kotlin Multiplatform 完全ガイド：iOS/Android 共通 AI ロジックの設計から App Store 公開まで"
...
この記事では、KMP プロジェクトへの Gemini API 統合を、セットアップから本番デプロイまで動作確認済みのコードで解説します。
