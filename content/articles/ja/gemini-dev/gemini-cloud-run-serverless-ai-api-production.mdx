---
title: "Gemini 3.1 Pro × Cloud Run：サーバーレスAI APIの本番構築"
...
ここで扱うのはGemini 3.1 Pro を Cloud Run にデプロイし、SSEストリーミング対応・コールドスタート最適化・本番監視まで含めた**プロダクション品質のAI API**を構築する方法を、実際のコードとともに解説します。
