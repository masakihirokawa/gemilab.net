...
author: "Gemini Lab"
description: "Google Labs がオープンソース化した Stitch の DESIGN.md フォーマットを解説します。Design Tokens とコンポーネント仕様の構造、CLI ツールとエクスポート、ライセンスと成熟度を整理し、自分のプロジェクト用 DESIGN.md の作成まで実践します。"
