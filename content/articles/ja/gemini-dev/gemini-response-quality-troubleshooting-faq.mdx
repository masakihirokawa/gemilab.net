...
author: "Gemini Lab"
description: "Gemini の出力品質に関する7つの FAQ です。ハルシネーション対策、temperature による回答の揺れ、JSON フォーマットの崩れ、古い API を参照するコード生成、max_output_tokens での途切れ、System Instruction が反映されない問題などを解説します。"
...
<table>
  <thead>
    <tr><th>用途</th><th>推奨temperature</th></tr>
  </thead>
  <tbody>
    <tr><td>事実確認・情報検索</td><td>0.0-0.3</td></tr>
    <tr><td>技術的な説明</td><td>0.3-0.5</td></tr>
    <tr><td>創造的なコンテンツ作成</td><td>0.7-0.9</td></tr>
    <tr><td>質疑応答・会話</td><td>0.5-0.7</td></tr>
  </tbody>
</table>
