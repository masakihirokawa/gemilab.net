...
書籍で Flutter の設計を一通り押さえておきたい方には「[Flutter実践開発（中西壮祐 著）](https://www.amazon.co.jp/dp/4297136066/?tag=pinocchio-22)」が手元に置いておくと便利でした。状態管理・テスト戦略の章は、ここで触れたチャット UI を保守しやすくするためのリファレンスとしても活きます。
