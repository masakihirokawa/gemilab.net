...
noindex: true
author: "Gemini Lab"
description: ".geminiignore で Gemini CLI と Code Assist のコンテキスト窓を整理し、回答精度とトークン消費を同時に改善する方法です。.gitignore との違い、最低限入れたいパターン集、モノレポでの応用、効果を計測する手順、関連設定との使い分けを解説します。"
