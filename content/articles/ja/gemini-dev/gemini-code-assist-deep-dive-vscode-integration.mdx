---
title: "Gemini Code AssistをVS Codeに統合する"
...
author: "Gemini Lab"
description: "VS Code に Gemini Code Assist を統合し、デフォルト設定のままでは得られない生成品質を引き出す方法を解説します。初速を上げるプロンプトの工夫、ファイル参照キャッシングの活用、標準補完との共存、React コンポーネント生成の実例を扱います。"
