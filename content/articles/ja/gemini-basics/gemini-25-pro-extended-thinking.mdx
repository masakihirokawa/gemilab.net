...
<table>
  <thead>
    <tr><th>項目</th><th>通常モード</th><th>拡張思考モード</th></tr>
  </thead>
  <tbody>
    <tr><td>推論時間</td><td>短い（数秒）</td><td>長い（10〜60秒）</td></tr>
    <tr><td>精度</td><td>高い（基本的には十分）</td><td>より高い（複雑問題向け）</td></tr>
    <tr><td>コスト</td><td>低い</td><td>やや高い</td></tr>
    <tr><td>用途</td><td>テキスト生成、質問回答</td><td>数学、コード、論理問題</td></tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr><td><code>type</code></td><td>string</td><td><code>"enabled"</code> で拡張思考を有効化。デフォルトは <code>"disabled"</code></td></tr>
    <tr><td><code>budget_tokens</code></td><td>int</td><td>思考プロセスに割当てる最大トークン数（1000～100000）</td></tr>
  </tbody>
</table>
