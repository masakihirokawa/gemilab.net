...
**ステータスページの確認**: Google Workspace Status Dashboard（[www.google.com](https://www.google.com/appsstatus）で) Gemini のサービス状況を確認できます。Google 全体で障害が発生している場合は、少し時間をおくしかありません。
