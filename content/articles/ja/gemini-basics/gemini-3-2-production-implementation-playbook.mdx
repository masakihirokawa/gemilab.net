...
highlights:
  - "Pro/Flash/Nanoのモデル選定を5分で決める判断フレームワークと、私の実運用での選定例"
  - "Streaming・Function Calling・Multimodal API の実装パターンとコード例（TypeScript）"
  - "Claude・GPT との実用比較ベンチマークと、Gemini 3.2 が圧倒的に強い領域・苦手な領域の整理"
---
